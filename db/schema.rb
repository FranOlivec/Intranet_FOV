...
ActiveRecord::Schema[7.0].define(version: 2023_09_21_185204) do
  ...
  add_foreign_key "applications", "job_offers", on_delete: :cascade
  add_foreign_key "applications", "users", on_delete: :cascade
  add_foreign_key "job_offers", "users", on_delete: :cascade
end
